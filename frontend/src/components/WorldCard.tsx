...
import { LevelProgress } from '../lib/localStorageManager';
...
const WORLD_THEME_COLORS: Record<string, { primary: string; light: string; dark: string }> = {
  garden: { primary: 'oklch(0.75 0.12 145)', light: 'oklch(0.88 0.10 145)', dark: 'oklch(0.55 0.15 145)' },
  ocean: { primary: 'oklch(0.65 0.15 220)', light: 'oklch(0.82 0.12 220)', dark: 'oklch(0.45 0.18 220)' },
  candyland: { primary: 'oklch(0.72 0.18 330)', light: 'oklch(0.85 0.15 330)', dark: 'oklch(0.55 0.20 330)' },
  forest: { primary: 'oklch(0.55 0.18 155)', light: 'oklch(0.72 0.15 155)', dark: 'oklch(0.38 0.20 155)' },
  volcano: { primary: 'oklch(0.60 0.28 25)', light: 'oklch(0.78 0.22 25)', dark: 'oklch(0.42 0.30 25)' },
  space: { primary: 'oklch(0.45 0.20 270)', light: 'oklch(0.62 0.18 270)', dark: 'oklch(0.28 0.22 270)' },
  desert: { primary: 'oklch(0.70 0.15 60)', light: 'oklch(0.85 0.12 60)', dark: 'oklch(0.50 0.18 60)' },
  arctic: { primary: 'oklch(0.80 0.08 240)', light: 'oklch(0.92 0.05 240)', dark: 'oklch(0.60 0.12 240)' },
  jungle: { primary: 'oklch(0.50 0.20 150)', light: 'oklch(0.68 0.16 150)', dark: 'oklch(0.35 0.24 150)' },
  crystal: { primary: 'oklch(0.75 0.18 300)', light: 'oklch(0.88 0.14 300)', dark: 'oklch(0.55 0.22 300)' },
  shadow: { primary: 'oklch(0.35 0.12 280)', light: 'oklch(0.55 0.10 280)', dark: 'oklch(0.20 0.15 280)' },
  rainbow: { primary: 'oklch(0.70 0.25 0)', light: 'oklch(0.85 0.20 0)', dark: 'oklch(0.50 0.30 0)' },
};

export default function WorldCard({ world, progress, isUnlocked, onSelectLevel }: WorldCardProps) {
  const { t } = useLanguage();
    ...
    >
      ...
      <CardHeader className="relative z-10">
        <CardTitle className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div 
              ...
              style={{
                ...
                boxShadow: isUnlocked ? `0 0 20px ${themeColors.primary}` : 'none',
              }}
            >
              <img 
                src={worldIcon} 
          ...
          {!isUnlocked && (
            <div 
              className="p-3 rounded-full bg-gray-700/80 backdrop-blur-sm"
            >
          ...
          <>
            ...
            <div className="flex items-center justify-between mb-4 bg-white/95 backdrop-blur-sm rounded-lg p-3 shadow-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-lg">{progress.totalStars} / 90</span>
              </div>
                ...
                return (
                  <div key={levelId} className="flex flex-col items-center gap-1">
                    <Button
                      ...
                      `}
                      style={{
                        borderColor: levelCompleted ? themeColors.primary : '#d1d5db',
