        ...
        <DialogContent className="sm:max-w-md" onPointerDownOutside={(e) => e.preventDefault()}>
          ...
          <form onSubmit={handlePasswordSubmit} className="space-y-4">
            ...
            <div className="flex gap-3">
              ...
              <Button type="button" variant="outline" onClick={onBack} disabled={isLoggingIn}>
                İptal
              </Button>
            </div>
          </form>
          ...
          <CardContent>
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-blue-800">
                <strong>Not:</strong> Oyuncu verileri artık tarayıcıda localStorage ile saklanmaktadır. 
                Bu panel sadece sistem genelindeki ses dosyalarını yönetmek içindir.
              </p>
            </div>
            <AudioManagement />
          </CardContent>
