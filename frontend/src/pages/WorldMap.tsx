...
const WORLDS = [
  ...
  { id: 3, name: 'candyland', emoji: '🍭', theme: 'candyland', requiredStars: 144 },
  ...
  { id: 10, name: 'crystal', emoji: '💎', theme: 'crystal', requiredStars: 648 },
  { id: 11, name: 'shadow', emoji: '🌑', theme: 'shadow', requiredStars: 720 },
  { id: 12, name: 'rainbow', emoji: '🌈', theme: 'rainbow', requiredStars: 792 },
];

export default function WorldMap({ onSelectLevel, onBackToTitle, currentTheme }: WorldMapProps) {
  const { t } = useLanguage();
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {WORLDS.map((world) => {
            ...
            const completedLevels = worldProgress.levels.filter(l => l.completed).length;
            const totalStars = worldProgress.levels.reduce((sum, l) => sum + l.stars, 0);
