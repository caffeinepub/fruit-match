...
import type { Language } from "../lib/localStorageManager";
...
> = {
  ...
  [Theme.candyland]: {
    ...
    emoji: "🍭",
    gradient:
      "from-fruit-candyland-light via-fruit-candyland to-fruit-candyland-dark",
  ...
  [Theme.volcano]: {
    ...
    emoji: "🌋",
    gradient:
      "from-fruit-volcano-light via-fruit-volcano to-fruit-volcano-dark",
...
export default function TitleScreen({
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden">
      <div
        className={`absolute inset-0 bg-gradient-to-br ${themeGradient} opacity-70 transition-all duration-1000`}
      />
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {allThemes.map((theme) => {
              ...
              return (
                ...
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${config.gradient} ${isSelected ? "opacity-80" : "opacity-70 group-hover:opacity-80"} transition-opacity duration-300`}
                  />
