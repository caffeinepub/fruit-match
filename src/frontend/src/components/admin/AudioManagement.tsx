                          ...
                          <div className="flex items-start justify-between">
                            <div className="space-y-1 flex-1">
                              ...
                              <div className="text-sm text-gray-600 space-y-1">
                                ...
                                {file.world && (
                                  <p>
                                    <span className="font-medium">Dünya:</span>{" "}
                                    {file.world}
                                  </p>
                                )}
                              </div>
                            ...
                            <div className="flex gap-2 ml-4">
                              <Button
                                ...
                                variant="outline"
                                onClick={() =>
                                  handlePlayAudio(file.blob.getDirectURL())
                                }
                              >
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              <strong>{selectedAudio?.description}</strong> adlı ses dosyası
              silinecek. Bu işlem geri alınamaz. Devam etmek istediğinizden emin
              misiniz?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
