...
export default function BulkAudioUploader() {
  ...
  const handleBulkPaste = () => {
    ...
    if (lines.length !== 19) {
      toast.error(
        `19 URL bekleniyor, ${lines.length} URL bulundu. Her satıra bir URL girin.`,
      );
      return;
    }
    ...
    toast.success(
      '19 URL başarıyla yüklendi! Şimdi "Tümünü İndir ve Yükle" butonuna tıklayın.',
    );
  };
  ...
  const handleBulkUpload = async () => {
    ...
    for (const mapping of AUDIO_FILE_MAPPINGS) {
      ...
      try {
        ...
        // Download from URL
        console.log(
          `[BulkUploader] Downloading: ${mapping.filename} from ${url}`,
        );
        ...
        console.log(
          `[BulkUploader] ✓ Successfully uploaded: ${mapping.filename}`,
        );
        ...
        console.error(
          `[BulkUploader] ✗ Failed to process ${mapping.filename}:`,
          error,
        );
    ...
    const errorCount = uploadStatuses.filter(
      (s) => s.status === "error",
    ).length;
    ...
    <Card className="shadow-xl">
      <CardHeader>
        ...
        <CardDescription className="text-lg">
          Tüm oyun ses dosyalarını tek seferde indirin ve yükleyin. 19 MP3
          dosyası için URL'leri girin.
        </CardDescription>
      </CardHeader>
        ...
        {showBulkInput && (
          <div className="space-y-4 border-2 border-dashed border-blue-300 rounded-lg p-6 bg-blue-50">
            ...
            <p className="text-sm text-blue-800">
              19 MP3 dosyası için URL'leri aşağıya yapıştırın. Her satıra bir
              URL girin (toplam 19 satır). Sıralama: Garden, Forest, Tropic,
              Ice, Volcano, Space, Tile Click, Tile Match, Tile Clear, Layer
              Open, Bomb, Clock, Magnifier, Shuffle, Level Complete, Star
              Earned, New World Unlock, Button Click, Reward Claim
            </p>
            <Textarea
...
... (19 URL toplam)`}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-xs text-gray-500">
                        Dosya: {mapping.filename} | ID: {mapping.id} | Context:{" "}
                        {mapping.context}
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-2">
          ...
          <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
            ...
            <li>
              Toplu giriş için: Tüm URL'leri kopyalayıp yapıştırın (her satıra
              bir URL, doğru sırada)
            </li>
            <li>Tek tek giriş için: Her dosya için URL'yi ayrı ayrı girin</li>
            <li>
              Tüm URL'ler girildikten sonra "Tümünü İndir ve Yükle" butonuna
              tıklayın
            </li>
            <li>
              Sistem her dosyayı sırayla indirecek ve backend blob storage'a
              yükleyecek
            </li>
            <li>
              İşlem tamamlandığında ses dosyaları otomatik olarak oyunda
              kullanılır
            </li>
            <li>Başarısız yüklemeler için hata mesajları gösterilir</li>
            <li>
              Sayfa yenilendikten sonra sesler otomatik olarak yüklenecektir
            </li>
          </ul>
        </div>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
          <h4 className="font-semibold mb-2">
            📝 Gerekli Dosyalar (19 adet) - Doğru Sıralama
          </h4>
